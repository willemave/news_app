...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_user_integration_sync_state_connection_id"), table_name="user_integration_sync_state"
    )
    ...
    op.drop_index(op.f("ix_user_integration_connections_user_id"), table_name="user_integration_connections")
    op.drop_index(op.f("ix_user_integration_connections_provider"), table_name="user_integration_connections")
    op.drop_index(op.f("ix_user_integration_connections_is_active"), table_name="user_integration_connections")
