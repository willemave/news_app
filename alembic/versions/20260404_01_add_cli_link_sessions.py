...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_cli_link_sessions_approved_by_user_id"), "cli_link_sessions", ["approved_by_user_id"], unique=False)
    op.create_index(op.f("ix_cli_link_sessions_expires_at"), "cli_link_sessions", ["expires_at"], unique=False)
    op.create_index(op.f("ix_cli_link_sessions_session_id"), "cli_link_sessions", ["session_id"], unique=True)
    op.create_index(op.f("ix_cli_link_sessions_user_api_key_id"), "cli_link_sessions", ["user_api_key_id"], unique=False)
    op.create_index(
