...
down_revision: Union[str, None] = '824291a177f2'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_contents_checked_out_by'), 'contents', ['checked_out_by'], unique=False)
    ...
    op.create_index('idx_task_status_created', 'processing_tasks', ['status', 'created_at'], unique=False)
    op.create_index(op.f('ix_processing_tasks_content_id'), 'processing_tasks', ['content_id'], unique=False)
