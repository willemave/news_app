...
down_revision: Union[str, None] = '5755b73ec0da'
...
def upgrade() -> None:
    ...
    op.create_index('idx_content_favorites_session_content', 'content_favorites', ['session_id', 'content_id'], unique=True)
    op.create_index(op.f('ix_content_favorites_content_id'), 'content_favorites', ['content_id'], unique=False)
    op.create_index(op.f('ix_content_favorites_session_id'), 'content_favorites', ['session_id'], unique=False)
