...
# from app.processor import download_and_process_content, url_preprocessor # Commented out due to refactoring
...
#     def test_download_html_content_success(self, mock_head, mock_extraction, mock_get_req):
...
#         mock_get_response.text = "<html><body>Test content</body></html>"
#         mock_get_response.raise_for_status = Mock()
#         mock_get_req.return_value = mock_get_response
...
#     @patch('app.processor.requests.get')
#     @patch('app.processor.requests.head') # Added mock_head for consistency
#     def test_download_content_fetch_failure(self, mock_head, mock_get_req):
#         \"""Test handling when requests.get for HTML fails.\"""
#         # Mock HEAD request (assuming it passes or is handled)
#         mock_head_response = Mock()
#         mock_head_response.headers = {'content-type': 'text/html'} # or '' if HEAD fails
#         mock_head.return_value = mock_head_response

#         # Simulate requests.get raising an exception for HTML
#         mock_get_req.side_effect = RequestException("Network error during GET")
...
#     @patch('app.processor.requests.get')
#     @patch('app.processor.bare_extraction')
#     @patch('app.processor.requests.head') # Added mock_head
#     def test_download_content_extraction_failure(self, mock_head, mock_extraction, mock_get_req):
...
#         # Mock requests.get for HTML
#         mock_get_response = Mock()
#         mock_get_response.text = "<html><body>Test</body></html>"
#         mock_get_response.raise_for_status = Mock()
#         mock_get_req.return_value = mock_get_response
...
#     @patch('app.processor.bare_extraction')
#     @patch('app.processor.requests.head')
#     def test_download_content_too_short(self, mock_head, mock_extraction, mock_get_req):
...
#     @patch('app.processor.bare_extraction')
#     @patch('app.processor.requests.head')
#     def test_download_content_uses_preprocessor(self, mock_head, mock_extraction, mock_get_req, mock_preprocessor):
