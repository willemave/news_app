...
| `app/services/vendor_usage.py` | `start_usage_context`, `end_usage_context`, `snapshot_usage`, `record_model_usage` | Shared vendor usage tracking for per-run aggregation. |
