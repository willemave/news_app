...
class _FakeHtmlStrategy:
    ...
    def __init__(self, extracted_data: dict[str, object]) -> None:
    ...
    def extract_data(self, _content: str, _url: str) -> dict[str, object]:
        return dict(self._extracted_data)

    def prepare_for_llm(self, extracted_data: dict[str, object]) -> dict[str, str]:
...
def _build_gate_extracted_data() -> dict[str, object]:
    return {
