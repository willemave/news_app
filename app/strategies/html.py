...
from app.models.metadata import ContentType, ProcessingResult
    ...
    async def process(self, url: str, content: str | None = None) -> ProcessingResult:
        ...
        try:
            ...
            metadata = {
                ...
                "reading_time_minutes": max(1, len(article_text.split()) // 200)
                if article_text
                else 0,
            }
            ...
            return ProcessingResult(
                success=False, content_type=ContentType.ARTICLE, error_message=str(e)
            )
